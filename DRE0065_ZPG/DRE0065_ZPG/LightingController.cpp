...
void LightingController::applyL(ShaderProgram* shaderProgram, int currentScene, int scene2LightsCount, int forestMode, const vec3* fireflyPos, int fireflyCount, vec3 camPos, vec3 camDir, bool flashlightOn)
{
