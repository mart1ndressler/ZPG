...
class Scene
{
    public:
        ...
        void setFov(float f);
        int scene2Mode = 4, scene2Lights = 1;
    ...
    private:
        ...
        vec3 fireflyPos[5], fireflyVel[5];
        ...
        void generateInstances(vector<vec4>& out, int n, float ds, float da, float smin, float smax, const vector<vec4>* av);
